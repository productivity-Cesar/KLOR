...
#define SHT_TAB MT(MOD_LSFT, KC_TAB)

// RIGHT HAND HOME ROW MODS ├───────────────────────────────────┐

#define SHT_N MT(MOD_RSFT, KC_N)
#define SHT_QUOT MT(MOD_LSFT, KC_QUOT)
...
*/ 
   [_QWERTY] = LAYOUT_polydactyl(
    //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
       ...
       SHT_TAB,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,                          KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  SHT_QUOT,
...
/*
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    SHT_TAB,  KC_A,     KC_R,     KC_S,     KC_T,     KC_D,                          KC_H,     KC_N,     KC_E,     KC_I,     KC_O,     SHT_QUOT,
    KC_SCLN,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_LBRC,  KC_RBRC,   KC_K,     KC_M,     KC_COMM,     KC_DOT,     KC_SLSH,  KC_BSLS,
                                  KC_LCTL,   LOWER,   KC_SPC,   KC_ESC,   KC_LGUI,   KC_ENT,   RAISE,    KC_BSPC
 ),
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_MUTE,   KC_MPLY,  KC_PEQL,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, 
 ...
 /*
   ...
   ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤╭────────╮╭────────╮├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
   │  MAKE   │ OS SWAP │ DVORAK  │ RGB VAL │         │         ││  MUTE  ││PLY/PSE ││         │   F1    │   F2    │   F3    │   F10   │   F11   │
   └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┼╰────────╯╰────────╯┼─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
                                 │    ▼    │    ▼    │    ▼    │    ▼    ││    ▼    │    ▼    │    ▼    │    ▼    │  
                                 └─────────┴─────────┴─────────┴─────────┘└─────────┴─────────┴─────────┴─────────┘ */ 
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
        QK_AUDIO_TOGGLE,   KC_A,  UG_HUEU,  UG_HUED,  UG_NEXT,                       XXXXXXX,  KC_F7,    KC_F8,    KC_F9,    KC_F14,   
    QK_BOOT,  DB_TOGG,  QWERTY,   UG_SATU,  UG_SATD,  RGB_M_P,                       XXXXXXX,  KC_F4,    KC_F5,    KC_F6,    KC_F12,   KC_F13,
    MAKE_H,   OS_SWAP,   COLEMAK,  UG_VALU,  UG_VALD,  RGB_M_R,  KC_MUTE,   KC_MPLY,  XXXXXXX,  KC_F1,    KC_F2,    KC_F3,    KC_F10,   KC_F11,
                                  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______
 )
...
bool oled_task_kb(void) {
    ...
    if (is_keyboard_master()) {  // ────────────────────────── PRIMARY SIDE
        ...
        static const char PROGMEM klor_face[] = {
          ...
          , 
          ...
          
        };
